...
<svelte:head>
	<title>Radicle User Guide</title>
	<meta name="description" content="Get started with Radicle." />
</svelte:head>
		...
		<div class="space-y-12">
			<section class="site-hero" bind:this={heroEl}>
				<div class="space-y-5">
					...
					<h1 class="hero-title">Radicle User Guide</h1>
					<p class="hero-subtitle">Get started with Radicle.</p>
				</div>
