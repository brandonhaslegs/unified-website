    ...
    <div class="space-y-12">
      ...
      <section class="site-hero" bind:this={heroEl}>
        <div class="space-y-5">
          ...
          <h1 class="hero-title">Seeder Guide</h1>
          <p class="hero-subtitle">
            Run a seed node to keep repositories available.
          </p>
        </div>
        <div
          class="hero-art"
      ...
      <main class="max-w-4xl">
        <article
          class="guide-content text-primary-light dark:text-primary-dark"
        >
          {@html guideHtml}
        </article>
      </main>
